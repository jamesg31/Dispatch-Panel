...
const changelog = [
  {
    ...
    date: "2024-06-17",
    changes: [
      "ADDED: This welcome page! It will appear on first open and after each update.",
      "ADDED: More customizable transmit logs, now inlcuding timestamps if wanted. Can be configured within the settings.",
      "UPDATED: Improved spacing around the transmit log icon.",
      "ADDED: Always on top option. This will attempt to force the panel to stay on top of other windows even on focus loss. Can be enabled in the settings.",
